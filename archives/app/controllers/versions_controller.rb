class VersionsController < ApplicationController
  before_filter :set_variables, :only => [ :new, :create ]
  ...
  def create
    ...
    respond_to do |format|
      if @child.save
        flash[:notice] = "#{@item.name} version #{@child.name} was successfully added."
  ...
  #       format.xml  { render :xml => @version.errors.to_xml }        
  #     end
  #   end
  # end
  # 
